...
//wifi information
const char* ssid = "KRP_Kuunteluauto_nro.3"; //Type your wifi ssid (name) here
const char* wifi_password = "10203040"; //Type your wifi password here

//MQTT information
const char* mqtt_server = " "; //IP of your MQTT broker
